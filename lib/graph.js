...
function show_node_info(d) {
  ...
  if ( ! d.flags.client ) {
    ...
    statimg = "http://status.freifunk-muenchen.de/munin-cgi/munin-cgi-graph/freifunk-muenchen.de/srv01.freifunk-muenchen.de/ffmuc_clients_" + d.id.replace(/:/g,'') + "-day.png"
    statlink = "node.html?id=" + d.id
    nodeinfo.append("a")
            .attr("href", statlink)
            .append("img")
            .attr("src", statimg)
            .attr("onerror", "this.src=sorry.png")
            .attr("width","300")
  }
...
var visible = {clients: false, vpn: false, labels: true}
