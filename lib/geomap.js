...
function update(data) {
  ...
  if (ffmapConfig.constrainBounds == true) {
    if (t[0][0] < ffmapConfig.constrainedBound[0][0]) { t[0][0] = ffmapConfig.constrainedBound[0][0] }
    if (t[1][0] < ffmapConfig.constrainedBound[0][1]) { t[1][0] = ffmapConfig.constrainedBound[0][1] }
    if (t[0][1] > ffmapConfig.constrainedBound[1][0]) { t[0][1] = ffmapConfig.constrainedBound[1][0] }
    if (t[1][1] > ffmapConfig.constrainedBound[1][1]) { t[1][1] = ffmapConfig.constrainedBound[1][1] }
  }
