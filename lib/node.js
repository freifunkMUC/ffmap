function nodedetails(container, fn) {
  ...
  function update(data) {
      ...
      clients_day.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_clients-' + id.replace(/:/g, '') + '-day.png');
      clients_day.setAttribute('onerror', 'this.src="sorry.png"');      
      var clients_week = document.createElement('img');
      clients_week.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_clients-' + id.replace(/:/g, '') + '-week.png');
      ...
      trafficthroughput_day.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_trafficthroughput-' + id.replace(/:/g, '') + '-day.png');
      ...
      trafficthroughput_week.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_trafficthroughput-' + id.replace(/:/g, '') + '-week.png');
      ...
      traffic_day.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_traffic-' + id.replace(/:/g, '') + '-day.png');
      ...
      traffic_week.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_traffic-' + id.replace(/:/g, '') + '-week.png');
      ...
      uptime_day.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_uptime-' + id.replace(/:/g, '') + '-day.png');
      document.getElementById('graphs_uptime').appendChild(uptime_day);
      var uptime_week = document.createElement('img');
      uptime_week.setAttribute('src', ffmapConfig.munin_path + 'ffmuc_uptime-' + id.replace(/:/g, '') + '-week.png');
