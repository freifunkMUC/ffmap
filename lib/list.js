function nodetable(table, fn) {
  ...
  function update(data) {
    ...
    row.append("td").text(function (d) { 
      if(!d.flags.online)
      { return "" }      
      return d.autoupdater.enabled?d.autoupdater.branch:"off" })
    row.append("td").text(function (d) { return d.contact })
